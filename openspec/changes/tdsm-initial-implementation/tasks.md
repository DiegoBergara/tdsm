...
- [ ] 3.1 Define and create SQLite schema: managed_sessions, chat_context, command_history (per PRD)
...
- [ ] 7.1 Sessions handler: /new, /list, /use, /current, /rename, /kill (delegate to session manager and context store)
